...
def test_column_stats_and_filter_one_column_with_stats(
    ...
    lib.create_column_stats_experimental(sym, col_stats)
...
def test_column_stats_three_chained_filter_clauses(
    ...
    lib.create_column_stats_experimental(sym, {"col_1": {"MINMAX"}, "col_2": {"MINMAX"}, "col_3": {"MINMAX"}})
...
def test_column_stats_batch_read(in_memory_version_store, clear_query_stats, column_stats_filtering_enabled):
    ...
    for s in [sym1, sym2]:
        ...
        lib.write(s, df0)
        lib.append(s, df1)
        lib.create_column_stats_experimental(s, {"col": {"MINMAX"}})
...
def test_column_stats_timestamp_column(
    ...
    lib.create_column_stats_experimental(sym, {"ts": {"MINMAX"}})
...
def test_column_stats_cross_column_comparison(
    ...
    lib.create_column_stats_experimental(sym, {"a": {"MINMAX"}, "b": {"MINMAX"}, "c": {"MINMAX"}, "d": {"MINMAX"}, "e": {"MINMAX"}})
...
def test_column_stats_cross_column_comparison_nan(
    ...
    lib.create_column_stats_experimental(sym, {"a": {"MINMAX"}, "b": {"MINMAX"}})
...
def test_column_stats_dynamic_schema_cross_column(
    ...
    lib.create_column_stats_experimental(sym, {"a": {"MINMAX"}, "b": {"MINMAX"}, "c": {"MINMAX"}})
...
def test_column_stats_empty_stats(in_memory_version_store, column_stats_filtering_enabled):
    ...
    lib.create_column_stats_experimental(sym, {"col": set()})
...
def test_column_stats_bool_comparison_operators(
    ...
    lib.create_column_stats_experimental(sym, {"bool_col": {"MINMAX"}})
...
def test_column_stats_bool_col_combined_with_comparison(
    ...
    lib.create_column_stats_experimental(sym, {"int_col": {"MINMAX"}, "bool_col": {"MINMAX"}})
...
def test_column_stats_bool_col_and_bool_value(
    ...
    lib.write(sym, df0)
    lib.append(sym, df1)
    lib.create_column_stats_experimental(sym, {"b": {"MINMAX"}})
...
def test_column_stats_two_bool_cols(in_memory_version_store, clear_query_stats, column_stats_filtering_enabled):
    ...
    lib.write(sym, df0)
    lib.append(sym, df1)
    lib.create_column_stats_experimental(sym, {"b1": {"MINMAX"}, "b2": {"MINMAX"}})
